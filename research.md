...
3. **Query rewriting** — Claude optimizes the resolved question for vector search
...
- **Streaming NDJSON** — client sees real-time trace events (`evaluating`, `thinking`, `vector_search`, `vision_render`, `done`, etc.)
